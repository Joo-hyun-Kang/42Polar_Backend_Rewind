...
export class Polar1727688653506 implements MigrationInterface {
    name = 'Polar1727688653506'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "mentors" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "intraId" character varying(50) NOT NULL, "slackId" character varying(100), "name" character varying(50), "email" character varying(100), "company" character varying(100), "duty" character varying(100), "profileImage" character varying(100), "availableTime" character varying, "introduction" character varying(150), "tags" character varying(150) array, "isActive" boolean NOT NULL, "markdownContent" text, "createAt" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "updateAt" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), CONSTRAINT "UQ_42a4c318980d9b0316b1c414c96" UNIQUE ("intraId"), CONSTRAINT "PK_67a614446eab992e4d0580afebf" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TABLE "bocals" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "name" character varying(10), "intraId" character varying(50) NOT NULL, "createdAt" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), CONSTRAINT "UQ_dc9bf8d24d429a28799d96c0b72" UNIQUE ("intraId"), CONSTRAINT "PK_fc425bc67545ad0e82ed96e8995" PRIMARY KEY ("id"))`);
